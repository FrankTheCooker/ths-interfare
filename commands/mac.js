...
exports.run = (client, message, args, func) => {
  ...
  if (!message.member.roles.some(r => ["Staff"].includes(r.name)))
    ...
    let role1 = message.guild.roles.find(r => r.name === "Pink")
    let role2 = message.guild.roles.find(r => r.name === "Vice Chairman");
    let role3 = message.guild.roles.find(r => r.name === "Dyno Verification");
    let role4 = message.guild.roles.find(r => r.name === "Customer Support");
    let role5 = message.guild.roles.find(r => r.name === "Server Moderator");
    let role6 = message.guild.roles.find(r => r.name === "Verified");
    let role7 = message.guild.roles.find(r => r.name === "Bilingual");
    let role8 = message.guild.roles.find(r => r.name === "Notified People");
    let role9 = message.guild.roles.find(r => r.name === "+Announcer Permissions");
    let role10 = message.guild.roles.find(r => r.name === "Support Team");
    let role11 = message.guild.roles.find(r => r.name === "Staff");
    let role12 = message.guild.roles.find(r => r.name === "=== LR Section ===");
    let role13 = message.guild.roles.find(r => r.name === "=== MR Section ===");
    let role14 = message.guild.roles.find(r => r.name === "=== HR Section ===");
    let role15 = message.guild.roles.find(r => r.name === "=== Colour Roles ===");
    let role16 = message.guild.roles.find(r => r.name === "=== Bot Managing ===");
    let role17 = message.guild.roles.find(r => r.name === "=== Normal ===");
    let role18 = message.guild.roles.find(r => r.name === "=== Level Roles ===");
    let role19 = message.guild.roles.find(r => r.name === "eval");
    let role20 = message.guild.roles.find(r => r.name === "Updates");
    let role21 = message.guild.roles.find(r => r.name === "Level 15");
    let role22 = message.guild.roles.find(r => r.name === "Kidnapped Delivery person");
