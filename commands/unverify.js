...
exports.run = (client, message, args, func) => {
  ...
  message.channel.send(`<:success:523531815072301092> Changed roles for ${member.user.tag}, +${role2.name}, -${role.name}, -${role2.name}`)
  client.guilds.get("479268202866540564").channels.get("517118784016744448").send(`${message.author} used **unverify**`)
}
